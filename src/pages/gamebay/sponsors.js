...
import { SponsorTable } from "../../sections/gamebay/sponsors/sponsor-table";
...
const Page = () =>{
  ...
  const checkToken = async () => {
    ...
    const Addsponsor = async (e) => {
      ...
      setLoading(true);
      try {
        const response = await fetch("http://82.148.2.56:8088/api/addSponsor", {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
            accept: "application/json",
