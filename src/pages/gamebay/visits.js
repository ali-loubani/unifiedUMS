...
import { VisitsSearch } from "../../sections/gamebay/visits/visits-search";
import { VisitsTable } from "../../sections/gamebay/visits/visits-table";
...
const Page = () => {
  ...
  const fetchData = async () => {
    try {
      const response = await fetch("http://82.148.2.56:8088/api/visits", {
        headers: {
          "Content-Type": "application/json",
          accept: "application/json",
          Authorization: "Bearer " + Cookies.get("usertoken"),
  ...
  const fetchDataDate = async () => {
    ...
    try {
      const response = await fetch(
        "http://82.148.2.56:8088/api/visits?from=" + dateFrom + "&to=" + dateTo,
        {
          headers: {
            "Content-Type": "application/json",
            accept: "application/json",
