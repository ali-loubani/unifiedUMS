...
import { SponsorTable } from "../../sections/mindpalace/sponsors/sponsor-table";
...
const Page = () =>{
  ...
  const Addsponsor = async (e) => {
    ...
    setLoading(true);
    try {
      const response = await fetch("http://89.232.186.173:8088/api/addSponsor", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          accept: "application/json",
    ...
    const handleExport = () => {
        ...
        const worksheet = XLSX.utils.table_to_sheet(document.getElementById("sponsor"));
    ...
    >
      ...
      <>
        <Head>
        <title>Sponsors | Mind Palace</title>
      </Head>
        ...
        >
          <Container maxWidth="xl">
            <Stack spacing={3}>
              ...
              <SponsorTable data={data.sponsors}
                loading={loading} 
      ...
      <Modal open={addsponsor}
      onClose={() => setAddSponsor(false)}>
        <div
          style={{
            display: "flex",
            justifyContent: "center",
