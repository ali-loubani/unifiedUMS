...
import { ConversionsSearch } from "../../sections/guesswho-uzbek/conversions/conversion-search";
import { ConversionsTable } from "../../sections/guesswho-uzbek/conversions/conversion-table";
...
const Page = () => {
  ...
  const fetchData = async () => {
    try {
      const response = await fetch("http://82.148.6.228:3000/conversions");
  ...
  const fetchDataDate = async () => {
    ...
    try {
      const response = await fetch(
        "http://82.148.6.228:3000/conversions?from=" +
          dateFrom +
          "&to=" +
          dateTo
      );
  ...
  return (
    <>
      {loadingPage ? (
        ...
        <>
          <Head>
            <title>Conversions | Guess Who</title>
          </Head>
          <Box
            component="main"
            sx={{
