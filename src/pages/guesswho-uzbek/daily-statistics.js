...
import { DailyTable } from "../../sections/guesswho-uzbek/daily-statistics/daily-table";
...
const Page = () => {
  ...
  const fetchDataDate = async () => {
    ...
    try {
      const response = await fetch(
        "http://taxmin-qil.uz/cms/include/daily_report_statistics.php?from=" +
          dateFrom +
          "&to=" +
          dateTo +
          "&operator=" +
  ...
  return (
    <>
      {loadingPage ? (
        ...
        <>
          <Head>
            <title>Daily Statistics | Guess Who</title>
          </Head>
          <Box
            component="main"
            sx={{
              ...
              <Grid container alignItems="center" spacing={2}>
                ...
                <Grid item>
                  ...
                  >
                    ...
                    <MenuItem value="12">campaign12</MenuItem>
                    <MenuItem value="13">campaign13</MenuItem>
                  </Select>
                </Grid>
                <Grid item>
                  <Button
