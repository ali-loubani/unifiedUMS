            ...
            <Table id="subscriber">
              ...
              <TableBody>
                {data && data.length > 0 ? (
                    ...
                    <TableCell align="center">{data[0].deactiveDate}</TableCell>
                    <TableCell align="center">
                      {data[0].blocked == 1 ? "yes" : "no"}
                    </TableCell>
                    <TableCell align="center">{data[0].questionAllowed}</TableCell>
                    <TableCell align="center">{data[0].totalPoints}</TableCell>
                    <TableCell align="center">{data[0].totalCharge}</TableCell>
