...
export const CampaignTable = (props) => {
  ...
  const Delete = async (e) => {
    ...
    try {
      const response = await fetch(
        "http://82.148.2.56:8088/api/deleteCampaign/" + id,
        {
          method: "POST",
          headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        `http://82.148.2.56:8088/api/editCampaign/${campaign.id}`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
    ...
    <Card>
                    ...
                    .map((campaign) => {
                      return (
                        <TableRow hover key={campaign.id}>
                          ...
                          <TableCell align="center">
                            {campaign.total_visits}
                          </TableCell>
                          <TableCell align="center">
                            {campaign.total_subscribers}
                          </TableCell>
                          <TableCell align="center">
      ...
      <TablePagination
        rowsPerPageOptions={[
          ...
          50,
          100,
          (data && data.length) > 100 && data.length,
        ]}
        component="div"
