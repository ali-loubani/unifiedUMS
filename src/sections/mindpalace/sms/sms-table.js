...
import { BeatLoader } from "react-spinners";
  ...
  export const SMSTable = ({ message, choosenOp }) => {
    ...
    const fetchData = async () => {
      try {
        const response = await fetch("http://89.232.186.173:8088/api/smsTemplate", {
          method: "GET",
          headers: {
    ...
    const handleSubmit = async (e) => {
      ...
      try {
        const response = await fetch(`http://89.232.186.173:8088/api/editSms/${sms.id}`, {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
            accept: "application/json",
                    ...
                    .map((sms, index) => {
                      ...
                      return (
                        ...
                        <TableRow hover
                          ...
                          <TableCell align="center">{sms.sms_type_id}</TableCell>
                          <TableCell align="center">{sms.uzbek}</TableCell>
                          <TableCell align="center">{sms.russian}</TableCell>
                          <TableCell align="center">{sms.english}</TableCell>
