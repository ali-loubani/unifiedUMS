...
export const UsersTable = ({ message }) => {
  ...
  const Reset = async (e) => {
    e.preventDefault();
    try {
      const response = await fetch("http://89.232.186.173:8088/api/resetPassword/" + id, {
        method: "PATCH",
        headers: {
  ...
  const fetchData = async () => {
    try {
      const response = await fetch("http://89.232.186.173:8088/api/users", {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
          accept: "application/json",
  ...
  const Delete = async (e) => {
    setLoading(true);
    try {
      const response = await fetch("http://89.232.186.173:8088/api/deleteUser/" + id, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          accept: "application/json",
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(`http://89.232.186.173:8088/api/editUser/${user.id}`, {
        method: "PATCH",
        headers: {
          "Content-Type": "application/json",
          accept: "application/json",
